...
<title>@yield('title')</title>
  ...
  <link href="{{asset('assets/css/custom.css?v=1.147')}}" rel="stylesheet">
  <link href="{{asset('assets/css/main.css?v=1.33')}}" rel="stylesheet">
...
<!--  <div id="preloader"></div>-->
  ...
  <script src="{{ asset('assets/js/custom.js?v=1.7')}}"></script>
