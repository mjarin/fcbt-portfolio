...
<meta name="facebook-domain-verification" content="9n4o2zkh4pxidn2qqqznprkqm9ocl5" />    
 <meta name="csrf-token" content="{{ csrf_token() }}">
  ...
  <link href="{{asset('assets/css/main.css?v=1.147')}}" rel="stylesheet">
  <link href="{{asset('assets/css/custom.css?v=1.119')}}" rel="stylesheet">
    ...
    <div class="container-fluid" style="padding-left:3%;">
        <div class="row">
            <div class="single-page-img-swatch col-lg-5 col-md-4 col-sm-6 col-12 mb-1 ">
                <div class="big-img-div mb-1" >
                    <img loading="lazy" src="{{ asset('assets/img/gallery/'.$product->image.'?v=1.16')}}"
                    class="p-1" alt="..." style="">
                </div>
                ...
                <div class="small-img-div" style="margin-left:5%;">
                    ...
                    @endif
                    <img loading="lazy" style="border:1px solid;" src="{{ asset('assets/img/gallery/'.$product->image.'?v=1.8')}}" class="mt-1" height="50" width="50" alt="...">
        ...
        <div class="col-lg-7 col-md-4 col-sm-6 col-12 mb-2">
            <div class="row product_data quantity-div">
                    <h2 class="py-4 margin-top-h2" style="font-weight:bold; font-size:3vw;">{{$product->name}}</h2>
                        ...
                        {{-- @php
                        $attribute=App\Models\ProductAttribute::where('id','=',$product->attribute_id)->first();
                        $attrValue=App\Models\AttributeValue::where('product_attribute_id','=',$product->attribute_id)->get();
                        @endphp --}}
                        ...
                        <div class="col-lg-11 col-md-11 col-sm-9 col-8 size-button">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="checked_radio" id="inlineRadio1" value="3-4">
                                <label class="form-check-label" for="inlineRadio1">3-4 Years</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="checked_radio" id="inlineRadio2" value="5-6">
                                <label class="form-check-label" for="inlineRadio2">5-6 Years</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="checked_radio" id="inlineRadio3" value="7-8">
                                <label class="form-check-label" for="inlineRadio3">7-8 Years</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="checked_radio" id="inlineRadio3" value="9-10">
                                <label class="form-check-label" for="inlineRadio3">9-10 Years</label>
                              </div>
                        </div>
                        @endif
                    ...
                    <div class="col-lg-7 col-md-12 col-sm-12 col-12" style="margin-top:4%;">
                        <button  type="button" class="btn addToCartFromCateSearch mt-3 p-2 text-white btn-size"
                            ...
                            <!--<button type="button" class="btn mt-3 p-2 text-white btn-size addToCartFromBuyNow" data-toggle="modal"-->
                            <!--    data-target="#" value="{{$product->id}}" style="border-radius:5!important; background:#DA83A5; font-weight: bolder;">-->
       ...
       <div class="row p-2 mt-2 related-product-div">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-6 mb-2">
            ...
            <div class="card" style="min-height:230px; width:100%;">
                <div class="card-body text-center">
                 <img loading="lazy" src="{{ asset('assets/img/gallery/'.$rel_prod->image.'?v=1.5')}}"
...
<!--  <div id="preloader"></div>-->
  ...
  <script src="{{ asset('assets/js/custom.js?v=1.5')}}"></script>
