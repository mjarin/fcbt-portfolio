        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-5">
                ...
                <form id="form"  action="{{ url('add-product') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <label for="position" class="col-sm-4 control-label">Attributes (if have) </label>
                        <div class="col-sm-8">
                            <select name="attr_id" class="form-select form-control pr-2" aria-label="Default select example">
                                <option value="">Select a Attributes</option>
                                @foreach ($attributes as $attr)
                                    <option value="{{ $attr->id }}">{{ $attr->att_name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
