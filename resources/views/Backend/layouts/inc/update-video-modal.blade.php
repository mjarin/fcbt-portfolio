            ...
            <div class="modal-body px-5">
                <form id="form" class="form-horizontal" action="{{ url('update-video-tutorial') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label for="video_title" class="col-sm-4 col-form-label">Video Title</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label for="embade_code" class="col-sm-4 col-form-label">Embade Code</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label for="image" class="col-sm-4 col-form-label">Thumbnail</label>
                        <div class="col-sm-8">
