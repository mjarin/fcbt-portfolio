            ...
            <div class="modal-body px-5">
                <form id="form" class="form-horizontal" action="{{ url('add-new-category') }}" method="POST">
                    ...
                    <div class="form-group row">
                        <label for="cate_name" class="col-sm-4 col-form-label">Category Name</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label for="cate_image" class="col-sm-4 control-label">Category Image</label>
                        <div class="col-sm-8">
                            <input type="file" name="cate_image" id="input-file-now-custom-3"
                            class="form-control m-2" id="cate_image">
                        </div>
                    </div>
